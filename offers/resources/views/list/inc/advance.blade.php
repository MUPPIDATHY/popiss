					...
					<div class="col-lg-3">
		        		...
		        		<div class="row">
		        			<div class="col-md-12 align-items-end ftco-animate">
		        				<div class="form-group">
		          				...
		          				<div class="form-field">
		          					<div class="icon"><span class="fa fa-pencil fa-1"></span></div>
		        			...
		        			<div class="col-md-12 align-items-end ftco-animate">
		                      ...
		                      <div class="icon"><span class="fa fa-caret-down fa-2"></span></div>
		        			...
		        			<div class="col-md-12 align-items-end ftco-animate">
		        				<div class="form-group">
		        					...
		        					<div class="form-field">
		          					<div class="select-wrap">
		                      <div class="icon"><span class="fa fa-caret-down fa-2" aria-hidden="true"></span></div>
		                      <select name="" id="" class="form-control">
		                      	<option value="">Type</option>
