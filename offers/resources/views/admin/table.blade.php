...
<button type="button"id="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-sm">
              DELETE
                </button> 
      ...
      <div class="modal fade" id="modal-gl">
        ...
        <div class="col-md-10 mx-auto">
          <form>
               ...
               <div class="col-sm-6">
                        <input type="image" width="100" height="100" src="https://images.all-free-download.com/images/graphicthumb/small_black_dog_hd_picture_168893.jpg" alt="img" id="blah">
                ...
                <div class="form-group row">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" onChange="readURL(this)"class="custom-file-input" id="exampleInputFile">
                        <label class="custom-file-label" id="up" for="exampleInputFile"> Upload</label>
                      </div>
                      </div></div></div>
